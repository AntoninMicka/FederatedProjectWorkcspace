...
- Stav: [ ] [planned]; aktivováno po začlenění PR #34 dne 2026-09-19.
...
- [ ] [planned] **F-M3-BACKEND-01-A — Kontrakt backendu, capabilities, rolí a reuse review (cílová úroveň: designed).** Zmapovat Ollama-specific vazby, uzavřít provider-neutral model a verze, explicitní capability negotiation, target/binding identitu a oddělení role od modelu; popsat migraci bez změny uložených bindingů a run evidence.
