...
- [ ] [in progress] **F-M2-SUMMARY-01-A — Kontrakt souhrnu a reuse review (cílová úroveň: designed).** Upřesnit request, explicitní selection, bounded výstup, preview/publish hranici, provenance, privacy, run states a crash boundaries; prověřit reuse ContextBuilderu, Ollama adapteru, ChatRecords/Artifacts a Workspace bez nového úložiště či povinného RAG.
