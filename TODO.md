...
- [x] [completed] **F-UX-SETTINGS-01-B — Stránka nastavení a přesun Ollama formuláře (implemented, 2026-09-19).** Globální navigace otevírá nastavení bez projektu i z pracovního panelu, jediný Ollama formulář používá stávající autentizované API a chat zachovává pouze stav a odkaz. Návrat obnoví původní home/projektový pohled a aktivní záložku a znovu načte serverový binding. Cílených 9 testů prošlo, 2 skutečné Qt/WebEngine testy byly podmíněně přeskočeny; první běh uvnitř sandboxu selhal pouze zákazem lokálního socketu, opakování mimo něj prošlo.
