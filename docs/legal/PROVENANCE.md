...
Some early planning documents were imported into this repository before the
formal SPDX policy was introduced. Their origin is being reviewed as part of
the pre-release provenance audit.
