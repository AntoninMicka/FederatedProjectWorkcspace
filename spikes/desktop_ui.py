...
<header class="presenter-header"><div><span class="badge">Presenter · NÁCVIK</span><h1>Disclosure cockpit</h1><p>Projekt Demo workspace · jednání Ukázková schůzka · publikum Interní demo · revize r1</p></div>
...
.presenter-header{font-size:1.5em;min-height:72px;border:1px solid #dce3e9;background:#fff;border-radius:10px;padding:12px 16px}.presenter-header h1{font-size:28px;color:#162638;margin:6px 0}.presenter-header-state{display:flex;gap:12px;align-items:center;flex-wrap:wrap;justify-content:flex-end}.presenter-header-state strong{color:#176b60;font-size:12px}.presenter-header-state span{font-size:12px;color:#627183}#presenter-view{height:100%;min-height:0;display:flex;flex-direction:column;gap:10px}.presenter-layout{display:grid;grid-template-columns:15% 25% minmax(0,1fr);gap:14px;min-height:0;flex:1}.presenter-layout>nav,.presenter-layout>section,.presenter-layout>aside{min-width:0;min-height:0}
.presenter-deck,.presenter-speaker{background:#fff;border:1px solid #dce3e9;border-radius:12px;padding:16px;overflow:auto;height:100%}.presenter-speaker{width:100%;align-self:stretch}.presenter-deck h2{margin-top:0;font-size:16px}.presenter-deck ol{padding-left:24px;margin:0}.presenter-deck li{padding:9px 6px;color:#456276;cursor:pointer;border-radius:6px}.presenter-deck li:hover,.presenter-deck li[aria-current="true"]{background:#e0efe9;color:#176b60}.presenter-deck li.presenter-live{font-weight:700;border-left:3px solid #176b60}.presenter-deck li.presenter-visited{color:#82909d}.presenter-deck button{background:transparent;color:inherit;padding:0;text-align:left;font-weight:inherit;width:100%}.presenter-return-anchor{border-top:1px solid #dce3e9;padding-top:14px;font-size:12px}
